                ...
                if (Items.length > 0) {
                    ...
                    $.ajax({
                        ...
                        success: function (success) {
                            if (success) {
                                CreateModal("Factura", "Se facturo correctamente", function () {
